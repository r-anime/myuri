...
urlpatterns = [
    ...
    path("scan/trigger-stream/", views.trigger_stream_scan, name="trigger_stream_scan"),
    path("scan/stream-show/<int:show_id>/", views.scan_stream_show, name="scan_stream_show"),
